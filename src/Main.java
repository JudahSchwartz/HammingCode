...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Bits without encoding needed : " +( size = (int) Math.ceil(Math.log(map.size())/Math.log(2) * message.length() )));
        System.out.println("Bits used with encoding : " + encodedMessage.length());
